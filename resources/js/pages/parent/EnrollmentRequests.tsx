        ...
        <ParentLayout>
            ...
            <div className="space-y-6">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                    ...
                    <Link
                        href="/parent/enroll"
                        className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-gradient-to-r from-sky-500 to-teal-600 text-white text-sm font-semibold shadow-md hover:shadow-lg transition-all self-start sm:self-auto"
                    >
                ...
                {requests.length === 0 ? (
                    <div className="bg-white/70 backdrop-blur-sm rounded-2xl border border-white/80 shadow-sm p-16 text-center">
                        ...
                        <Link
                            href="/parent/enroll"
                            className="inline-flex items-center gap-2 mt-5 px-5 py-2.5 rounded-xl bg-gradient-to-r from-sky-500 to-teal-600 text-white text-sm font-semibold shadow-md hover:shadow-lg transition-all"
                        >
